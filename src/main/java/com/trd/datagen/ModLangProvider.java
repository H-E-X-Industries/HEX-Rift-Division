...
// English
    ...
    private void addRussian() {
        ...
        add("tooltip.trd.machine.hold_shift", "Нажмите Shift для подробного описания");
