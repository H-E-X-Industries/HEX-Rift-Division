...
public class OreVeinRegistry {
    ...
    public static class OreEntry {
        ...
        public OreEntry(String name, Block block, int veinSize, int minY, int maxY, int countPerChunk) {
            ...
            this.configuredKey = ResourceKey.create(
                    ...
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "ore_" + name)
            );
            this.placedKey = ResourceKey.create(
                    net.minecraft.core.registries.Registries.PLACED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "ore_" + name + "_placed")
            );
            this.biomeModifierKey = ResourceKey.create(
                    NeoForgeRegistries.Keys.BIOME_MODIFIERS,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "add_ore_" + name)
            );
        }
    }
    ...
    public static class SpecialOreEntry {
        ...
        public SpecialOreEntry(String name, Block block, int minY, int maxY,
            ...
            this.configuredKey = ResourceKey.create(
                    net.minecraft.core.registries.Registries.CONFIGURED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "special_ore_" + name)
            );
            this.placedKey = ResourceKey.create(
                    net.minecraft.core.registries.Registries.PLACED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "special_ore_" + name + "_placed")
            );
            this.biomeModifierKey = ResourceKey.create(
                    NeoForgeRegistries.Keys.BIOME_MODIFIERS,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "add_special_ore_" + name)
            );
        }
    }
    ...
    public static class ConglomerateEntry {
        ...
        public ConglomerateEntry(String name, int minY, int maxY, int minSize, int maxSize,
            ...
            this.configuredKey = ResourceKey.create(
                    net.minecraft.core.registries.Registries.CONFIGURED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "conglomerate_" + name)
            );
            this.placedKey = ResourceKey.create(
                    net.minecraft.core.registries.Registries.PLACED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "conglomerate_" + name + "_placed")
            );
            this.biomeModifierKey = ResourceKey.create(
                    NeoForgeRegistries.Keys.BIOME_MODIFIERS,
                    ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "add_conglomerate_" + name)
            );
        }
    }
