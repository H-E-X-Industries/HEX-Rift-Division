...
public class ModTrunkPlacerTypes {
    ...
    public static final Supplier<TrunkPlacerType<GiantSequoiaTrunkPlacer>> GIANT_SEQUOIA_TRUNK_PLACER =
    ...
    public static final Supplier<TrunkPlacerType<MiniSequoiaTrunkPlacer>> MINI_SEQUOIA_TRUNK =
            TRUNK_PLACER_TYPES.register("mini_sequoia_trunk",
                    () -> new TrunkPlacerType<>(MiniSequoiaTrunkPlacer.CODEC));

    public static final Supplier<TrunkPlacerType<MediumSequoiaTrunkPlacer>> MEDIUM_SEQUOIA_TRUNK =
