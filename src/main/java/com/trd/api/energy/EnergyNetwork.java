...
public class EnergyNetwork {
    ...
    public void tick(ServerLevel level) {
        ...
        for (EnergyNode node : nodes) {
            ...
            IEnergyProvider prov = level.getCapability(ModCapabilities.ENERGY_PROVIDER, node.getPos(), null);
            IEnergyReceiver rec = level.getCapability(ModCapabilities.ENERGY_RECEIVER, node.getPos(), null);

            boolean isProvider = prov != null;
            boolean isReceiver = rec != null;
