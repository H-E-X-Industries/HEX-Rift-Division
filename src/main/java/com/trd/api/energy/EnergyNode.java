...
public class EnergyNode {
    ...
    public boolean isValid(ServerLevel level) {
        ...
        return level.getCapability(ModCapabilities.ENERGY_PROVIDER, pos, null) != null ||
                level.getCapability(ModCapabilities.ENERGY_RECEIVER, pos, null) != null ||
                level.getCapability(ModCapabilities.ENERGY_CONNECTOR, pos, null) != null;
    }
