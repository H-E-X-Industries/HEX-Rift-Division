...
public class MachineBatteryModel extends GeoModel<MachineBatteryBlockEntity> {
    ...
    private static final ResourceLocation MODEL =
            ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "geo/machine_battery.geo.json");

    // Путь к текстуре — кладёшь в:
    // src/main/resources/assets/trd/textures/block/machine_battery.png
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MainRegistry.MOD_ID, "textures/block/machine_battery.png");
