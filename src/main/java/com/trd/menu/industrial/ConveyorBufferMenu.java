...
public class ConveyorBufferMenu extends AbstractContainerMenu {
    ...
    public ConveyorBufferMenu(int id, Inventory playerInv, ConveyorBufferBlockEntity be) {
        super(ModMenuTypes.CONVEYOR_BUFFER_MENU.get(), id);
        this.blockEntity = be;
        initSlots(playerInv);
    }
    ...
    private void initSlots(Inventory playerInv) {
        var handler = blockEntity != null ? blockEntity.getInventory() : new net.neoforged.neoforge.items.ItemStackHandler(27);
