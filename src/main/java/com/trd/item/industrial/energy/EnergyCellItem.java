...
public class EnergyCellItem extends Item implements GeoItem {
    ...
    public static long getStoredEnergy(ItemStack stack) {
        if (stack.isEmpty() || !stack.has(net.minecraft.core.component.DataComponents.CUSTOM_DATA)) return 0;
        return stack.get(net.minecraft.core.component.DataComponents.CUSTOM_DATA).copyTag().getLong(TAG_ENERGY);
    }
