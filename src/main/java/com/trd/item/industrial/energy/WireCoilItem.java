...
public class WireCoilItem extends Item {
    ...
    public static int getWires(ItemStack stack) {
        return stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag().getInt("Wires");
    }

    public static void setWires(ItemStack stack, int wires) {
        if (wires <= 0) {
            net.minecraft.nbt.CompoundTag tag = stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag(); tag.remove("Wires"); net.minecraft.world.item.component.CustomData.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, stack, tag);
        } else {
            net.minecraft.nbt.CompoundTag tag = stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag(); tag.putInt("Wires", Math.min(wires, MAX_WIRES)); net.minecraft.world.item.component.CustomData.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, stack, tag);
        }
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!(be instanceof ConnectorBlockEntity currentConnector)) {
            ...
            if (player != null && player.isShiftKeyDown() && stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag().contains("FirstPos")) {
                net.minecraft.nbt.CompoundTag tg = stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag(); tg.remove("FirstPos"); net.minecraft.world.item.component.CustomData.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, stack, tg);
        ...
        // ================= ВТОРОЙ КЛИК =================
            ...
            BlockPos firstPos = net.minecraft.nbt.NbtUtils.readBlockPos(tag, "FirstPos").orElse(null);
